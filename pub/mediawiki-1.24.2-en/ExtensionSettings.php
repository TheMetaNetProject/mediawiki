...
$questions = array (
    "Metaphors are not linguistic.  They are ..." => "conceptual",
    "A place where you can find many frames." =>  array( "framenet", "metanet" ),
    "The C in ECG" => array( "construction", "cxn" ),
    "Another word for frame element." => array ( 'role', 'participant' ),
    "Dog, cat, arm, tree: which is a human body part?" =>  "arm",
    "Run, fly, growl, swim: which of these is not a motion verb?" => "growl",
    "The first field on a frame page is ___." => "description",
    "The two main type of pages here are frames and ___." => "metaphors",
    "Mappings from a source domain to a target domain." => array ( "metaphor", "metaphors" ),
    "Has roles and relations." => "frame",
);
...
/**
* Settings for the ReplaceSet extension
*/

# increase max replacements per page
