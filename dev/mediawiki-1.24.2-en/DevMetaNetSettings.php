...
# set server url
$wgServer = '//ambrosia2.sys.icsi.berkeley.edu';
$wgCanonicalServer = 'http://ambrosia2.sys.icsi.berkeley.edu';
...
$smwgSparqlQueryEndpoint = "http://ambrosia2:8080/openrdf-sesame/repositories/$wgDBname";
$smwgSparqlUpdateEndpoint = "http://ambrosia2:8080/openrdf-sesame/repositories/$wgDBname/statements";
...
#$wgNamespacePermissionLockdown[NS_SPECIAL]['*'] = array('sysop');
...
# set cookie domain
$wgCookieDomain = 'ambrosia2.sys.icsi.berkeley.edu';
